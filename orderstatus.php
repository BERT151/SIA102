...
include'include/header.php';
    ...
    $user_products_query="select * from transaction ut inner join products it on it.id=ut.Product_ID where ut.Account_ID='$Account_ID' GROUP BY Order_ID";
                ...
                <div class="payment-terms">
                    <div class="payment-detail">
                      <?php 
                        ...
                        {?>
                        <p>Payment Info</p>
                        <p><span>Transaction #</span> <?php echo   $T_ID;?></p>
